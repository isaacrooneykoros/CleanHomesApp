...
import com.example.Sema.ui.theme.screens.insert.Courses
...
fun <RowScope> Text(text: RowScope, modifier: Modifier, color: Color, textAlign: TextAlign, fontSize: TextUnit) {
